...
class PubMedCollector:
    ...
    def search_studies(self, query: str, retmax: int = 100, 
                      date_start: str = "2015/01/01", 
                      date_end: str = "2024/12/31") -> List[str]:
    ...
    def _extract_article_data(self, record) -> Dict:
        ...
        return {
            ...
            'year': year,
            'doi': doi,
            'methylation_mentions': self._count_methylation_terms(title + " " + abstract),
    ...
    def _count_methylation_terms(self, text: str) -> int:
        ...
        terms = ['methylation', 'epigenetic', 'CpG', 'DNAm', '5mC', 'hypermethylation', 'hypomethylation']
    ...
    def _classify_study_type(self, text: str) -> str:
        ...
        elif any(word in text_lower for word in ['longitudinal', 'prospective', 'cohort']):
            return 'longitudinal'
